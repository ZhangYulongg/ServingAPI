...
class TestLowPrecisionPipeline(object):
    def setup_class(self):
        serving_util = ServingTest(data_path="low_precision", example_path="Pipeline/LowPrecision/ResNet50_Slim", model_dir="serving_server",
    ...
    def get_truth_val_by_inference(self):
        ...
        # 真实概率值
        self.truth_prob = np.max(self.truth_val["save_infer_model/scale_0.tmp_0"])
    ...
    def test_gpu_trt_int8(self):
        ...
        assert count_process_num_on_port(9993) == 0  # gRPC Server
        assert count_process_num_on_port(18080) == 0
