...
class TestPPYOLO(object):
    def setup_class(self):
        serving_util = ServingTest(data_path="detection/ppyolo_r50vd_dcn_1x_coco", example_path="Cpp/PaddleDetection/ppyolo_r50vd_dcn_1x_coco", model_dir="serving_server",
