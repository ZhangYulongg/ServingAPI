...
class TestYOLOv3(object):
    def setup_class(self):
        serving_util = ServingTest(data_path="detection/yolov3_darknet53_270e_coco", example_path="C++/PaddleDetection/yolov3_darknet53_270e_coco", model_dir="serving_server",
