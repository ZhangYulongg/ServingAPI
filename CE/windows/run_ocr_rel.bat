...
mkdir logs
cd whl_packages
wget --no-check-certificate https://paddle-serving.bj.bcebos.com/test-dev/whl/paddle_serving_app-0.7.0-py3-none-any.whl >nul 2>nul
wget --no-check-certificate https://paddle-serving.bj.bcebos.com/test-dev/whl/paddle_serving_client-0.7.0-cp38-none-any.whl >nul 2>nul
wget --no-check-certificate https://paddle-serving.bj.bcebos.com/test-dev/whl/paddle_serving_server_gpu-0.7.0.post1028-py3-none-any.whl >nul 2>nul
...
python -m pip install paddle_serving_app-0.7.0-py3-none-any.whl
python -m pip install paddle_serving_client-0.7.0-cp38-none-any.whl
python -m pip install paddle_serving_server_gpu-0.7.0.post1028-py3-none-any.whl
